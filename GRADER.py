...
class Grader:
    ...
    def run(self):
        ...
        self.__intervalize(alto, soprano, 'soprano/alto')
        self.__intervalize(tenor, soprano, ' soprano/tenor')
        self.__intervalize(bass, soprano, 'soprano/bass')
    ...
    @staticmethod
    def __intervalize(voice_1, voice_2, voice_names):
